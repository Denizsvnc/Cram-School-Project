	...
	import { yoklamaOlusturValidation, yoklamaGuncelleValidation } from './yoklama.validate';
	import validateRequest from '../../core/middlewares/validateRequest';

	const router = Router();

	router.post('/olustur', requireAuth, yetkiKontrol([Roller.YONETICI, Roller.MUDUR, Roller.OGRETMEN]), yoklamaOlusturValidation, validateRequest, yoklamaController.yoklamaOlustur);
	router.put('/:id', requireAuth, yetkiKontrol([Roller.YONETICI, Roller.MUDUR, Roller.OGRETMEN]), yoklamaGuncelleValidation, validateRequest, yoklamaController.yoklamaGuncelle);
